...
abstract class SearchListLocalDataSource {
  ...
  Future<List<SearchListModel>> getSearchHistoryObjectList(
      String tableName, Map<String, String> pic1Map);
  Future<void> updateSearchHistoryObjectList(int index, String tableName);
  Future<void> addSearchHistoryObjectList(
      SearchListModel element, String tableName);
}

class SearchListLocalDataSourceImpl extends SearchListLocalDataSource {
  @override
  Future<void> addCarObjectList(
  ...
  Future<void> updateSearchHistoryObjectList(
  ...
  Future<void> addSearchHistoryObjectList(
    ...
    SearchInputHive searchInputHive = SearchInputHive(
        memberNum: element.memberNum,
        callCount: element.callCount,
        makerCode1: element.makerCode1,
        makerCode2: element.makerCode2,
