...
class NewVersion {
  ...
  /// startTimerRequestGetStoreVersion
  /// resend after 5s will stop
  Future<bool> startTimerRequestGetStoreVersion(PackageInfo packageInfo) async {
    ...
    _timer = new Timer.periodic(
      ...
      (Timer timer) {
        if (_start == 0) {
          ...
          //print('timer_ $_start');
          _getAndroidStoreVersion(packageInfo);
          _start--;
        }
      },
    );
